...
import com.keyi.erp_saomiaochuku.bean.ERP_SaoMiao;
import com.keyi.erp_saomiaochuku.utils.ACache;
import com.keyi.erp_saomiaochuku.utils.UpdateManager;
...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onStart() {
        super.onStart();
        BmobQuery<ERP_SaoMiao> bmobQuery=new BmobQuery<ERP_SaoMiao>();
        bmobQuery.getObject(this, "HsAQDDD8", new GetListener<ERP_SaoMiao>() {
            @Override
            public void onSuccess(ERP_SaoMiao person) {
    ...
    private int getVersionCode(Context context)
    {
        ...
        try
        {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.keyi.erp_saomiaochuku", 0).versionCode;
